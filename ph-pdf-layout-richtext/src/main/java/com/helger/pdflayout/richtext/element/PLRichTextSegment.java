...
/**
 * A single rendered segment within a {@link PLRichTextLine}. A segment is a
 * stretch of text from one {@link PLRichTextRun} that fits on the current line.
 * It carries the resolved font information and the precomputed width so that
 * the render phase doesn't have to call into PDFBox metrics.
 *
