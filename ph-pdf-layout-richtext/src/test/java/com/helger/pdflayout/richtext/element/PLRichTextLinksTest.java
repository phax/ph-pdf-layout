...
/**
 * Port of the {@code LinksTest} from the pdfbox-layout source repo. Exercises
 * external hyperlinks, the no-underline link style, internal anchor references,
 * and anchor declarations.
 *
