...
/**
 * An interface for {@code IntSet}s, based on hash tables.
 *
 * <p>This interface doesn't carry own specific behaviour, just combines it's superinterfaces.
 *
 * <p>Looking for a way to instantiate a {@code HashIntSet}? See static factory methods
 * in {@link HashIntSets} class.
 *
 * @see HashIntSets
 * @see HashIntSetFactory
 */
