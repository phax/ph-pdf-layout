...
/**
 * An interface for {@code IntFloatMap}s, based on hash tables.
 *
 * <p>This interface doesn't carry own specific behaviour, just combines it's superinterfaces.
 *
 * <p>Looking for a way to instantiate a {@code HashIntFloatMap}? See static factory methods
 * in {@link HashIntFloatMaps} class.
 *
 * @see HashIntFloatMapFactory
 * @see HashIntFloatMaps
 */
public interface HashIntFloatMap extends IntFloatMap, HashContainer {
    ...
    @Override
    @Nonnull
    HashObjSet<Entry<Integer, Float>> entrySet();
}
