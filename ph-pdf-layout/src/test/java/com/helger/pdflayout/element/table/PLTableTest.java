...
public final class PLTableTest
{
  ...
  public void testTableWithStyleVariations () throws PDFCreationException
  {
    ...
    final PageLayoutPDF aPageLayout = new PageLayoutPDF ();
    aPageLayout.addPageSet (aPS1);
    PDFTestComparer.renderAndCompare (aPageLayout, new File ("pdf/pltable/variations.pdf"));
  }
  ...
  public void testGridTypes () throws PDFCreationException
  {
    ...
    final PageLayoutPDF aPageLayout = new PageLayoutPDF ();
    aPageLayout.addPageSet (aPS1);
    PDFTestComparer.renderAndCompare (aPageLayout, new File ("pdf/pltable/grid-types.pdf"));
  }
  ...
  public void testPartialGridTypes () throws PDFCreationException
  {
    ...
    final PageLayoutPDF aPageLayout = new PageLayoutPDF ();
    aPageLayout.addPageSet (aPS1);
    PDFTestComparer.renderAndCompare (aPageLayout, new File ("pdf/pltable/grid-types-partial.pdf"));
  }
  ...
  public void testNestedTable () throws PDFCreationException
  {
    ...
    final PageLayoutPDF aPageLayout = new PageLayoutPDF ();
    aPageLayout.addPageSet (aPS1);
    PDFTestComparer.renderAndCompare (aPageLayout, new File ("pdf/pltable/nested.pdf"));
  }
  ...
  public void testManyAutoHeightRows () throws PDFCreationException
  {
    ...
    final PageLayoutPDF aPageLayout = new PageLayoutPDF ();
    aPageLayout.addPageSet (aPS1);
    PDFTestComparer.renderAndCompare (aPageLayout, new File ("pdf/pltable/many-rows.pdf"));
  }
  ...
  public void testCellSpawningPage () throws PDFCreationException
  {
    ...
    aPageLayout.addPageSet (aPS1);
    PDFTestComparer.renderAndCompare (aPageLayout, new File ("pdf/pltable/cell-spawning-page.pdf"));
  }
  ...
  public void testCellSpawningPage2 () throws PDFCreationException
  {
    ...
    final PageLayoutPDF aPageLayout = new PageLayoutPDF ().setCompressPDF (false);
    aPageLayout.addPageSet (aPS1);
    PDFTestComparer.renderAndCompare (aPageLayout, new File ("pdf/pltable/cell-spawning-page2.pdf"));
  }
  ...
  public void testCellSpawningPageInnerTable () throws PDFCreationException
  {
    ...
    for (int i = 0; i < 3; ++i)
    {
      ...
      for (int j = 0; j < 20; ++j)
        aInnerTable.addAndReturnRow (new PLTableCell (new PLText (sLongText, r10).setID ("longtext").setPadding (2))
                                                                                                                    .setID ("celllongtext"),
                                     new PLTableCell (new PLText ("Short text", r10).setID ("shorttext")).setID (
                                                                                                                 "cellshorttext"))
                   .setID ("inner-row-" + i + "-" + j);
    ...
    final PageLayoutPDF aPageLayout = new PageLayoutPDF ().setCompressPDF (false);
    aPageLayout.addPageSet (aPS1);
    PDFTestComparer.renderAndCompare (aPageLayout, new File ("pdf/pltable/cell-spawning-page-inner-table.pdf"));
  }
  ...
  public void testColSpanRightAlign () throws PDFCreationException
  {
    ...
    PLDebugRender.withDebugRender (false, () -> {
      final PageLayoutPDF aPageLayout = new PageLayoutPDF ().setCompressPDF (false);
      aPageLayout.addPageSet (aPS1);
      PDFTestComparer.renderAndCompare (aPageLayout, new File ("pdf/pltable/colspan-right-align.pdf"));
    });
  }
  ...
  public void testDifferentColWidthTypes () throws PDFCreationException
  {
    ...
    final PageLayoutPDF aPageLayout = new PageLayoutPDF ().setCompressPDF (false);
    aPageLayout.addPageSet (aPS1);
    PDFTestComparer.renderAndCompare (aPageLayout, new File ("pdf/pltable/different-width-types.pdf"));
  }
  ...
  public void testDifferentColWidthTypesNotFullWidth () throws PDFCreationException
  {
    ...
    final PageLayoutPDF aPageLayout = new PageLayoutPDF ().setCompressPDF (false);
    aPageLayout.addPageSet (aPS1);
    PDFTestComparer.renderAndCompare (aPageLayout, new File ("pdf/pltable/different-width-types-not-full-width.pdf"));
  }
  ...
  public void testDifferentColWidthTypesTooWide () throws PDFCreationException
  {
    ...
    final PageLayoutPDF aPageLayout = new PageLayoutPDF ().setCompressPDF (false);
    aPageLayout.addPageSet (aPS1);
    PDFTestComparer.renderAndCompare (aPageLayout, new File ("pdf/pltable/different-width-types-too-wide.pdf"));
  }
  ...
  public void testWithImage () throws PDFCreationException, IOException
  {
    ...
    final PageLayoutPDF aPageLayout = new PageLayoutPDF ().setCompressPDF (false);
    aPageLayout.addPageSet (aPS1);
    PDFTestComparer.renderAndCompare (aPageLayout, new File ("pdf/pltable/table-with-images.pdf"));
  }
  ...
  public void testIssue21 () throws PDFCreationException
  {
    ...
    final PageLayoutPDF aPageLayout = new PageLayoutPDF ().setCompressPDF (false);
    aPageLayout.addPageSet (aPS1);
    PDFTestComparer.renderAndCompare (aPageLayout, new File ("pdf/pltable/issue21.pdf"));
  }
  ...
  public void testIssue21_BoxWithPadding () throws PDFCreationException
  {
    ...
    final PageLayoutPDF aPageLayout = new PageLayoutPDF ().setCompressPDF (false);
    aPageLayout.addPageSet (aPS1);
    PDFTestComparer.renderAndCompare (aPageLayout, new File ("pdf/pltable/issue21a.pdf"));
  }

  @Test
  public void testIssue30_NonSplittableRows () throws PDFCreationException
  {
    final FontSpec r10 = new FontSpec (PreloadFont.REGULAR, 10);
    final PLPageSet aPS1 = new PLPageSet (PDRectangle.A4);

    aPS1.addElement (new PLText ("First line (not splittable)", r10).setID ("first-line"));

    final String sShortText = "Dummy";
    final String sLongText = "Line 1\n  Line 2\nLine 3\n  Line 4\nLine 5\n  Line 6\nLine 7\n  Line 8";

    // Table with atomic rows
    {
      final PLTable aTable = PLTable.createWithEvenlySizedColumns (3).setID ("table1");
      for (int i = 0; i < 15; ++i)
      {
        final boolean bVertSplit = false;
        aTable.addAndReturnRow (new PLTableCell (new PLBox (new PLText (sLongText, r10)).setVertSplittable (
                                                                                                            bVertSplit)),
    ...
    aPS1.addElement (new PLText ("In-Between line", r10).setID ("inbetween-line"));

    // Table with non-atomic rows
    {
      final PLTable aTable = PLTable.createWithEvenlySizedColumns (3).setID ("table2");
      for (int i = 0; i < 15; ++i)
      {
        final boolean bVertSplit = true;
        aTable.addAndReturnRow (new PLTableCell (new PLBox (new PLText (sLongText, r10)).setVertSplittable (
                                                                                                            bVertSplit)),
                                new PLTableCell (new PLText (sShortText, r10).setVertSplittable (bVertSplit)),
                                new PLTableCell (new PLText (sShortText, r10).setVertSplittable (bVertSplit)))
    ...
    final PageLayoutPDF aPageLayout = new PageLayoutPDF ().setCompressPDF (false);
    aPageLayout.addPageSet (aPS1);
    PDFTestComparer.renderAndCompare (aPageLayout, new File ("pdf/pltable/issue30.pdf"));
  }
}
